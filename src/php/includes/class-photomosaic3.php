...
class Photomosaic3 {
    ...
    protected $version;
    protected $options_key = 'photomosaic3_options';
    protected $plugin_admin;
    protected $plugin_public;

    public function __construct () {
        $this->plugin_name = 'photomosaic3';
        $this->version = '3.0';
    ...
    private function load_dependencies () {
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-photomosaic3-loader.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-photomosaic3-admin.php';
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-photomosaic3-public.php';

        $this->loader = new Photomosaic3_Loader();
        // $this->plugin_admin = new Photomosaic3_Admin( $this->plugin_name, $this->version );
        $this->plugin_public = new Photomosaic3_Public( $this->plugin_name, $this->version );
    }
