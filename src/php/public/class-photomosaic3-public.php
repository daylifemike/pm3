...
class Photomosaic3_Public {
    ...
    public function enqueue_scripts () {
        ...
        wp_register_script( 'goog', $this->relative_url('../../../out/goog/base.js'), array(), $this->version, true );
        wp_register_script( $this->plugin_name, $this->relative_url('../../../main.js'), array('goog'), $this->version, true );
